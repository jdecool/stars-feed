...
- [jasonku09/grill-with-ui](https://github.com/jasonku09/grill-with-ui) - Agent-agnostic skill: run a grilling design interview on a local browser page instead of the terminal
...
- [hiblaphp/hibla](https://github.com/hiblaphp/hibla) - Modern Asynchonous Runtime for PHP
...
- [rootkit-io/awesome-malware-development](https://github.com/rootkit-io/awesome-malware-development) - Curated resources for malware dev, reverse engineering, and defensive security research.
...
- [pmjones/php-styler](https://github.com/pmjones/php-styler) - Reformats PHP code from scratch.
...
- [aboudoux/GestionFormation](https://github.com/aboudoux/GestionFormation) - This is an ERP for manage trainings written in DDD, CQRS/ES - WPF MVVM
...
- [Akeuuh/mdNotch](https://github.com/Akeuuh/mdNotch) - 
...
- [OpenVidu/openvidu](https://github.com/OpenVidu/openvidu) - OpenVidu Platform: self-hosted real-time video and audio for your apps, built on LiveKit and mediasoup
